...
In this python project, I have made an attendance system which takes attendance by using face recognition technique. I have also intergrated it with  (Graphical user interface)  GUI so it can be easy to use by anyone. GUI for this project is also made on python using tkinter.
